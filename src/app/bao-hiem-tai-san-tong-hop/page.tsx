...
import { PropertyInsuranceHero, PropertyInsuranceBody } from "@/components/PropertyInsuranceArticle";
...
export const metadata: Metadata = {
  ...
  description: "Các giải pháp bảo hiểm tài sản, trách nhiệm, pháp lý, nhà đất và kính.",
};
