    ...
    <section className="bg-brand-gold-tint py-12 lg:py-16">
      <div className="dvag-container">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-xl font-bold leading-tight text-text-strong sm:text-2xl">
        ...
        <div className="mt-10 grid grid-cols-1 gap-10 md:grid-cols-3 md:gap-12">
          {advantages.map((adv) => (
            <article key={adv.icon} className="text-center md:text-left">
              <Image
                ...
                width={120}
                height={120}
                className="mx-auto h-16 w-16 object-contain md:mx-0"
              />
              <h3 className="mt-5 text-sm font-bold leading-snug text-text-strong">
                {adv.headline}
              </h3>
              <p className="mt-3 text-xs leading-relaxed text-text-default sm:text-[13px]">
                {adv.body}
              </p>
            </article>
          ))}
