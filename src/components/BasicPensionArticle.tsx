    ...
    <article className="bg-[#e8f0f9] text-black">
      <section className="px-[10%] py-6 sm:py-8">
        <div className="mx-auto max-w-7xl">
          ...
          <ul className="mx-auto mt-8 max-w-6xl list-disc space-y-9 pl-6 text-2xl font-bold leading-snug lg:text-3xl">
          ...
          <h2 className="mt-10 text-center text-3xl font-bold leading-tight lg:text-4xl">
            ...
            {coreBenefits.map((benefit) => {
              ...
              return (
                <div key={benefit.title}>
                  ...
                  <p className="mx-auto mt-5 max-w-xs text-2xl leading-snug">{benefit.text}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="px-[10%] py-6 sm:py-8">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 space-y-8 text-2xl leading-snug lg:text-3xl">
            <section>
              <h3 className="text-3xl font-bold">Lương hưu cơ bản là gì?</h3>
              <ul className="mt-5 list-disc space-y-2 pl-8">
