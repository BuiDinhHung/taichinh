    ...
    <article className="bg-neutral-100 text-black">
      <section className="px-[10%] py-14 sm:py-16">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 lg:grid-cols-[1fr_180px]">
            ...
            <ProfileCircleIcon className="mx-auto h-36 w-36 text-brand-gold lg:h-44 lg:w-44" />
          </div>

          <div className="mt-8 max-w-7xl text-2xl leading-snug">
            <h2 className="text-3xl font-bold">Bảo vệ giá trị sức lao động của bạn</h2>
            <p className="mt-8">
            ...
            <h3 className="mt-10 text-3xl font-bold">Bảo hiểm mất khả năng lao động</h3>
            <p className="mt-8">Bảo vệ thu nhập hàng tháng dưới hình thức trợ cấp hưu trí nếu bạn:</p>
            ...
            <h3 className="mt-10 text-3xl font-bold">Bù đắp mất thu nhập do bệnh tật</h3>
            <p className="mt-8">
      ...
      <section className="px-[10%] py-14 sm:py-16">
        <div className="mx-auto max-w-5xl text-2xl leading-snug">
          ...
          <h2 className="mt-12 text-3xl font-bold">Bảo hiểm năng lực cơ bản (gói cao cấp)</h2>
          <p className="mt-8">Ngoài các quyền lợi của gói cơ bản, còn bảo hiểm thêm các năng lực:</p>
          <ul className="mt-8 list-disc pl-6">
          ...
          <h2 className="mt-12 text-3xl font-bold">Bảo hiểm mất khả năng lao động (gói cao cấp)</h2>
          <p className="mt-8">
